...
<head>
   ...
   <!--preloader-->
         ...
         <div class="content-wrapper">
            ...
            <section class="content">
               <div class="row">
                  ...
                  <div class="col-sm-4 col-sm-offset-4" id = "biometrics">
                     <div class="panel lobidisable panel-bd">
                        <div class="panel-heading">
                           <div class="panel-title">
                              <h4>Biometrics Verification</h4>
                           </div>
                        </div>
                        <div class="panel-body">
                           <form>
                              <div class="form-group">
                                 <label>NIN / VIN</label>
                                 <input type="text" class="form-control" placeholder="" id = "nrid" readonly required>
                              </div>

                              <div class="form-group">
                                 <label>Name</label>
                                 <input type="text" class="form-control" placeholder="" id = "nrName" readonly required>
                              </div>
                              <legend>Right Thumb</legend>
                              <div style = "text-align: center;">
                                  <img src = "/assets/image/biometrics2.png" />
                                    <br/>
                                  <div id = "spin">
                                    <i class="fa fa-spinner fa-spin" style="font-size:30px"></i>
                                  </div>
                                  <div class="form-group">
                                       <button type="button" class="btn btn-add" id = "bioButton"><i class="fa fa-check"></i> Confirm
                                       </button>
                                  </div>
                              </div>
                           </form>
      ...
      <script src="/activeJs/receiveMoney.js" type="text/javascript"></script>
      <!-- End Theme label Script
         =====================================================================-->
   </body>
